...
if (inputs) {
  ...
  var inputControls = [].slice.call(document.querySelectorAll('input:not([type="submit"]):not([type="hidden"]), select, textarea')); // save off labels as we will be adding stuff to the DOM this can get messed up as we do so
